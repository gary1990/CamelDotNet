...
{
    //VnaTotalResultDamage ViewModel,used to auto map procedure result returned by [p_coaxialqualitydamageTab_Rp] prodedure
    public class VnaTotalResultDamage
    {
        ...
        public int IsGreenLight { get; set; }
