...
namespace CamelDotNet.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<CamelDotNetUser> userManager)
        {
            UserManager = userManager;
        }

        public UserManager<CamelDotNetUser> UserManager { get; private set; }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new CamelDotNetUser() { UserName = model.UserName };
        ...
        private async Task SignInAsync(CamelDotNetUser user, bool isPersistent)
        {
        ...
        private void SignIn(CamelDotNetUser user, bool isPersistent)
        {
            AuthenticationManager.SignOut(DefaultAuthenticationTypes.ExternalCookie);
